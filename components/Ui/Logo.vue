...
<template>
  <NuxtLink to="/" class="flex items-center space-x-2.5">
    <div class="w-[2.125rem] aspect-[1/1] overflow-hidden">
      <svg width="2.125rem" height="2.125rem" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg"
        class="w-full h-auto">
        <path
    ...
    <span class="text-logo text-secondary">Interno</span>
  </NuxtLink>
</template>
