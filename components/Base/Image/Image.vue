...
<template>
  <div>
    ...
    >
      ...
      />
      <button
        class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 size-16 md:size-20 lg:size-24 rounded-full bg-white flex-center group hover:bg-dark transition duration-300 shadow-lg"
